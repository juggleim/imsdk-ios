...
#pragma mark - ImWebSocketRoot

@implementation ImWebSocketRoot
...
static GPBFileDescription ImWebSocketRoot_FileDescription = {
  .package = "web_socket_msg",
  .prefix = NULL,
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ImWebsocketMsg)
                               ...
                               fileDescription:&ImWebSocketRoot_FileDescription
                                        fields:fields
