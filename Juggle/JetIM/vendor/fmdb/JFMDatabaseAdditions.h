...
/** Category of additions for @c JFMDatabase  class.
...
@interface JFMDatabase (JFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `JFMResultSet` of schema; @c nil  on error.
