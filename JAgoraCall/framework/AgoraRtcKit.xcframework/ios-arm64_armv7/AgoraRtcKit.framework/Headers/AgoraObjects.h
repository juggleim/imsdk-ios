 ...
 * - `YES`: Enable multipath transmission.
 * - `NO`: Disable multipath transmission.
 * @note
...
/** Bitrate of the video:
 ...
 Refer to the table below and set your bitrate. If the bitrate you set is beyond the
...
/**
 * @brief Defines the buffer data for a watermark image.
 *
 * @since 4.6.0
 */
...
/**
 * @brief Configuration settings for applying a watermark.
 *
 * @since 4.6.0
 */
 ...
 *
 * This parameter is only effective when `modelType` is set to `SegModelTypeGreen`.
