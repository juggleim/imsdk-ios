...
ZEGOEXP_API zego_error EXP_CALL zego_express_start_recording_remote_data(
    struct zego_data_record_config config, const char *stream_id);
#else
...
/// @param stream_id play stream id.
#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API zego_error EXP_CALL zego_express_stop_recording_remote_data(const char *stream_id);
#else
typedef zego_error(EXP_CALL *pfnzego_express_stop_recording_remote_data)(const char *stream_id);
#endif
...
/// @param stream_id play stream id.
/// @param user_context Context of user.
typedef void (*zego_on_remote_data_record_state_update)(enum zego_data_record_state state,
                                                        zego_error error_code,
                                                        struct zego_data_record_config config,
...
ZEGOEXP_API void EXP_CALL zego_register_remote_data_record_state_update_callback(
    zego_on_remote_data_record_state_update callback_func, void *user_context);
#else
...
typedef void (*zego_on_remote_data_record_progress_update)(
    struct zego_data_remote_record_progress progress, struct zego_data_record_config config,
    const char *stream_id, void *user_context);

#ifndef ZEGOEXP_EXPLICIT
ZEGOEXP_API void EXP_CALL zego_register_remote_data_record_progress_update_callback(
    zego_on_remote_data_record_progress_update callback_func, void *user_context);
#else
