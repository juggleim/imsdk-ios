...
//    public internal(set) var channelURL: String?
    ...
    public var isOperator: Bool {
        //TODO:
//        if let groupChannel = self.channel as? JConversationInfo {
//            return groupChannel.myRole == .operator
//        } else if let openChannel = self.channel as? JConversationInfo {
...
//    public func channelWasChanged(_ channel: JConversationInfo) {
//        self.channel = channel
//        
//        let context = MessageContext(source: .eventChannelChanged, sendingStatus: .succeeded)
//        self.baseDelegate?.baseChannelSettingsViewModel(
