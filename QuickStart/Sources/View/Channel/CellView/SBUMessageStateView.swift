...
open class SBUMessageStateViewParams {
    ...
    public let sendingState: JMessageState
...
open class SBUMessageStateView: SBUView {
    ...
    var sendingState: JMessageState = .unknown
    ...
    ///
    /// - Since: 2.1.13
    public init(sendingState: JMessageState, receiptState: SBUMessageReceiptState, isQuotedReplyMessage: Bool = false) {
        self.receiptState = receiptState
        self.sendingState = sendingState
        self.isQuotedReplyMessage = isQuotedReplyMessage
...
//                )
    ...
    private func willEnterForeground() {
        guard sendingState == .sending else { return }
