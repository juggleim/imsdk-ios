...
public class SBUMessageReactionViewParams {
    ...
    let reactions: [JMessageReactionItem]
...
open class SBUMessageReactionView: SBUView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    public var reactions: [JMessageReactionItem] = []
    ...
    var errorHandler: ((_ error: JErrorCode) -> Void)?
...
//        }
        ...
        let emojiKey = reaction.reactionId
        
        let selectedEmoji = emojiList.first(where: { $0 == reaction.reactionId })
        cell.emojiImageViewRatioConstraint?.isActive = false
        cell.configure(
            type: .messageReaction,
            emoji: nil,
        ...
        DispatchQueue.main.async {
            ...
            for userInfo in reaction.userInfoList {
                if userInfo.userId == JIM.shared().currentUserId {
                    isSelected = true
                    break
                }
            }
    ...
    open func collectionView(
        ...
        self.emojiTapHandler?(reaction.reactionId)
    }
...
//        }
    ...
    open func collectionView(
        ...
        let count = reactions[indexPath.row].userInfoList.count
