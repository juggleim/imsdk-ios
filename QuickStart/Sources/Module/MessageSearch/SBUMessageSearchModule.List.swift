...
public protocol SBUMessageSearchModuleListDataSource: AnyObject {
    ...
    func messageSearchModule(_ listComponent: SBUMessageSearchModule.List, searchResultsInTableView tableView: UITableView) -> [JMessage]
}
...
extension SBUMessageSearchModule {
    ...
    open class List: UIView {
        ...
        public var resultList: [JMessage] {
        ...
        open func message(at indexPath: IndexPath) -> JMessage? {
