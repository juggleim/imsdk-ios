...
extension SBUBaseChannelModule {
    ...
    open class Input: UIView, SBUMessageInputViewDelegate, SBUMessageInputViewDataSource {
        ...
        public func messageInputView(_ messageInputView: SBUMessageInputView, willChangeMode mode: SBUMessageInputMode, message: JMessage?) {
            self.baseDelegate?.baseChannelModule(self, willChangeMode: mode, message: message)
        }
        
        public func messageInputView(_ messageInputView: SBUMessageInputView, didChangeMode mode: SBUMessageInputMode, message: JMessage?) {
